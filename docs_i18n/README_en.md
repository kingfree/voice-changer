...
## Rust/Vue Prototype
A minimal prototype using Rust for the backend and Vue for the frontend is available in the `rust_vue` directory. The backend exposes `/openapi.json` describing its API.
